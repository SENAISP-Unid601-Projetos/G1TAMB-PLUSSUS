...
import 'inicio.dart'; // Para formatação de datas
...
class Agendamento extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AgendamentoPage(), // Tela inicial que leva ao agendamento
    );
  }
}
...
class _AgendamentoConsultaScreenState extends State<AgendamentoConsultaScreen> {
  ...
  void _scheduleAppointment() {
    ...
    // Exibe SnackBar com a confirmação da consulta
    ...
    // Atraso de 1 segundo para garantir que o SnackBar seja exibido
    Future.delayed(Duration(seconds: 1), () {
      ...
      // Atraso de 2 segundos antes de navegar para a nova página
      Future.delayed(Duration(seconds: 2), () {
        // Fecha o diálogo de loading
        Navigator.of(context, rootNavigator: true).pop();

        // Navega para a página "Fila", substituindo a tela atual
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => Fila(), // Substitua "Fila" pela sua página
          ),
        );
      });
    });
